...
class PrecosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mercado_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'produto_id' => 1,
                'mercado_id' => 1,
                'created' => '2021-01-23 16:42:49',
                'modified' => '2021-01-23 16:42:49',
                'user_id' => 1,
            ],
        ];
        parent::init();
